...
for url in urls:
    ...
    # Parsing timestamp
    # Find the timestamp div element
    # Assuming you already have the BeautifulSoup object as `soup`
    ...
    scraped_data.append([count, headline_text, pub_date , article_content,url, 'CNN'])
    if count % 1000 == 0:
